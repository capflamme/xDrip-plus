 ...
 * Modified by capflamme on 25/12/2023.
 */
...
public class LibreReceiver extends BroadcastReceiver {
    ...
    public static volatile double libre2Noise = -99999;
    public static volatile TrendLine libre2NoisePoly = null;
                    ...
                    try {
                        ...
                        switch (action) {
                            ...
                            case Intents.LIBRE2_BG:
                                ...
                                Log.v(TAG,"Updating readings every " + Pref.getStringToInt("Libre2ReadingInterval", 5) +" min");
                                if(!BgReading.last_within_millis(DexCollectionType.getCurrentDeduplicationPeriod())) {
                                    BgReading lastBGReading = BgReading.last(true);
                                    if (lastBGReading == null) {
                                        Log.v(TAG,  "No BG reading available. Triggering a new one.");
                                    }
                                    else {
                                    ...
                                    if (!(Pref.getString("Libre2SmoothingMethod", "Default").equals("Default"))) {
                                        ...
                                        List<Libre2RawValue> libre2NoiseRawValues = Libre2RawValue.weightedAverageInterval(smoothing_minutes);
                                        ...
                                        smoothingValues = Libre2RawValue.weightedAverageInterval(smoothing_window);
                                    }
                                    else {
                                        ...
                                        smoothingValues = Libre2RawValue.weightedAverageInterval(dataFetchInterval);
                                    }
    ...
    private static void processValues(Libre2RawValue currentValue, List<Libre2RawValue> smoothingValues, long smoothing_minutes, Context context) {
        ...
        if (Pref.getString("Libre2SmoothingMethod", "Default").equals("Median")) {
            ...
            value = calculateWeightedAverage(smoothingValues, currentValue.timestamp, TimeUnit.MINUTES.toMillis(smoothing_minutes));
        }
